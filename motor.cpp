...
adr_Motorcycle alokasi_Motorcycle (infotype_Motorcycle x) //alokasi entitas 2
{
    adr_Motorcycle Q;
    Q = new elm_Motorcycle;
    info(Q) = x;
    next(Q) = NULL;
    prev(Q) = NULL;
    return Q;
...
bool isEmpty_Motorcycle (list_Motorcycle L) //cek list motor
{
    if ((first(L) == NULL) && (last(L) == NULL) )
        return true;
    else
...
void createList_Motorcycle (list_Motorcycle &L) //buat list motor
{
    first(L) = NULL;
    last(L) = NULL;
}
...
void insert_Motorcycle (list_Motorcycle &L, adr_Motorcycle Q) //insert motor (insert first)
{
    adr_Motorcycle P;
    P = first(L);

    if (!isEmpty_Motorcycle(L))
    {
        next(Q) = P;
        prev(P) = Q;
        first(L) = Q;
...
void insert_history (list_pelanggan &L, list_Motorcycle L2, infotype_history x, int id_Motorcycle, int id) //insert history (insert last)
{
    adr_pelanggan P;
    P = first(L);
    adr_Motorcycle R;
    ...
    while ( P != NULL )
    {
        ...
        {
            while ( ( info(R).id_Motorcycle != id_Motorcycle ) && ( next(R) != NULL ) )
            {
                R = next(R);
            }
            if ( info(R).id_Motorcycle == id_Motorcycle )
            {
                Motorcycle(Q) = R;
            }
...
void delete_Motorcycle (list_Motorcycle &L, int id)
{
    adr_Motorcycle P,Q,R;
    P = first(L);

    if ( !isEmpty_Motorcycle(L) )
    {
        while ( ( info(P).id_Motorcycle != id ) && ( next(P) != NULL ) )
        {
            P = next(P);
        }
        if ( info(P).id_Motorcycle == id )
        {
            if ( ( prev(P) != NULL ) && ( next(P) != NULL ) )
            {
                Q = prev(P); R = next(P);
...
void view_Motorcycle (list_Motorcycle L)
{
    adr_Motorcycle P;
    P = first(L);
    ...
    if ( !isEmpty_Motorcycle(L) )
    {
        cout << "==Motorcycle Data that already inputed==";
        cout << endl;
        cout << endl;
        while ( next(P) != NULL )
        {
            cout << "The Brand of The Motorcycle    : ";
            cout << info(P).merek; cout << endl;
            cout << "Production Year         : ";
            cout << info(P).tahun; cout << endl;
            cout << "Motorcycle ID                  : ";
            cout << info(P).id_Motorcycle; cout << endl;
            cout << endl;
            P = next(P);
        }
        cout << "The Brand of The Motorcycle    : ";
...
void view_motorpelanggan (list_pelanggan L)
{//clear
    adr_pelanggan P;
    adr_history Q;
    adr_Motorcycle R;
    ...
    if ( !isEmpty_pelanggan(L) )
    {
        cout << "==Data pelanggan dan motor yang di sewa==";
        cout << endl; cout << endl;
        while ( P != NULL )
        {
            if ( first_history(P) != NULL )
            {
                ...
                cout << endl;
                cout << "The Motorcycle that rented : " << endl; cout << endl;
                Q = first_history(P);
                ...
                while ( Q != NULL )
                {
                    ...
                    cout << "Motorcycle ID : "; cout << info(R).id_Motorcycle << endl;
                    cout << endl;
                    Q = next(Q);
            ...
            else
            {
                ...
                cout << "No.Hp: "; cout << info(P).hp << endl;
                cout << endl;
                cout << "The rented Motorcycle that not returned yet : ";
                cout << endl; cout << endl;
            }
            cout << "========================================";
            cout << endl; cout << endl;
...
void view_pelangganmotor (list_pelanggan L, list_Motorcycle L2)
{
    adr_pelanggan P;
    adr_Motorcycle Q,S;
    adr_history R,T;
    ...
    while ( Q != NULL )
        {
            cout << "==Motorcycle Data=="; cout << endl;
            cout << "The Brand of The Motorcycle      : "; cout << info(Q).merek; cout << endl;
            cout << "Production Year           : "; cout << info(Q).tahun; cout << endl;
            cout << "Motorcycle ID                    : "; cout << info(Q).id_Motorcycle; cout << endl;
            cout << endl;
            cout << "This Motorcycle is Rented by : "<<endl;
            P = first(L);
            while ( P != NULL )
            {
                int idx = 0, z = 0;
                ...
                if ( R != NULL )
                {
                    do
                    {
                        T = R;
                        S = Motorcycle(T);
                        if ( info(S).id_Motorcycle == info(Q).id_Motorcycle )
                        {
                            tmp[idx] = info(P).nama;
                            idx = idx+1;
                        }
...
void Motorcyclei (list_pelanggan L, int x)
{
    adr_pelanggan P;
    P = first(L);
...
void report (list_pelanggan L, list_terbanyak1 &L2)
{
    ...
    if ( !isEmpty_pelanggan(L))
    {
        while ( P != NULL )
        {
            ...
            {
                cout << "no Motorcycle tenant yet" << endl;
            }
            P = next(P);
        }
        T = first(L2);
        if ( tmp2 != 0 )
        {
            ...
            while ( i <= tmp2 )
            {
                ...
                cout << "The total of Motorcycle that rented : ";
